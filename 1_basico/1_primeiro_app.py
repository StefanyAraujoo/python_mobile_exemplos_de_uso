...
def main(page: ft.Page):
    ...
    page.title = "Meu Primeiro App com Flet"  # Título que aparece na aba do navegador
    page.padding = 20  # Espaçamento interno da página

    # Criando nosso primeiro elemento: um texto
    meu_texto = ft.Text(
        value= "🎉 Olá, Mundo! (Primeiro app com Flet!)", # O texto que será exibido
    ...
    # Vamos sdicionar mais alguns elementos para tornar mais interessante
    page.add(
